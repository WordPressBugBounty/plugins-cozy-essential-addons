...
<div class="wp-block-group has-light-color-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:6rem;padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40","margin":{"top":"0","bottom":"84px"}}},"layout":{"type":"constrained","contentSize":"680px"}} -->
    ...
    <div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"350px"} -->
        ...
        <div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"fontSize":"big"} -->
            ...
            <!-- wp:paragraph -->
            <p><?php esc_html_e('This theme completely transformed my website with its sleek design and intuitive customization options. The setup was effortless, and my site now looks professional and modern. The performance is fast, and I’ve noticed a boost in engagement. Highly recommended!', 'cozy-essential-addons') ?></p>
            <!-- /wp:paragraph -->

            <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20","margin":{"top":"28px"}}},"layout":{"type":"constrained"}} -->
            <div class="wp-block-group" style="margin-top:28px"><!-- wp:heading {"level":4,"fontSize":"medium"} -->
                <h4 class="wp-block-heading has-medium-font-size"><?php esc_html_e('Liana Povmen', 'cozy-essential-addons') ?></h4>
                <!-- /wp:heading -->
    ...
    <div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","style":{"spacing":{"blockGap":"var:preset|spacing|30"}}} -->
        <div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"fontSize":"big"} -->
            ...
            <!-- wp:paragraph -->
            <p><?php esc_html_e('I was amazed at how easy it was to customize my site. The pre-built templates saved me hours, and the speed optimization is top-notch. My store looks stunning, loads quickly, and provides a seamless shopping experience. This theme is a must-have for any online business!', 'cozy-essential-addons') ?></p>
            <!-- /wp:paragraph -->

            <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20","margin":{"top":"28px"}}},"layout":{"type":"constrained"}} -->
            <div class="wp-block-group" style="margin-top:28px"><!-- wp:heading {"level":4,"fontSize":"medium"} -->
                <h4 class="wp-block-heading has-medium-font-size"><?php esc_html_e('Robert Head', 'cozy-essential-addons') ?></h4>
                <!-- /wp:heading -->
    ...
    <div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"350px"} -->
        ...
        <div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"fontSize":"big"} -->
            ...
            <!-- wp:paragraph -->
            <p><?php esc_html_e('This product has completely streamlined my website building process. The layouts are professional, the customization is simple, and the features are incredibly powerful. My site went from basic to outstanding in no time. Worth every penny for the quality it delivers!', 'cozy-essential-addons') ?></p>
            <!-- /wp:paragraph -->

            <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20","margin":{"top":"28px"}}},"layout":{"type":"constrained"}} -->
            <div class="wp-block-group" style="margin-top:28px"><!-- wp:heading {"level":4,"fontSize":"medium"} -->
                <h4 class="wp-block-heading has-medium-font-size"><?php esc_html_e('Liza Walkman', 'cozy-essential-addons') ?></h4>
                <!-- /wp:heading -->
