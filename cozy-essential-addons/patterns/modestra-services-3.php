...
/**
 * Title: PRO: Services Section with sticky style 3
 * Slug: cozy-essential-addons/modestra-services-3
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)"><!-- wp:columns {"style":{"spacing":{"margin":{"top":"48px"},"blockGap":{"left":"64px"}}}} -->
    <div class="wp-block-columns" style="margin-top:48px"><!-- wp:column {"width":"50%","style":{"spacing":{"blockGap":"var:preset|spacing|30"}}} -->
        <div class="wp-block-column" style="flex-basis:50%"><!-- wp:group {"style":{"position":{"type":"sticky","top":"0px"},"spacing":{"padding":{"top":"40px","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"constrained","contentSize":"100%"}} -->
            <div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:40px;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"level":3,"className":"is-style-modestra-heading-gradient-effect","style":{"typography":{"lineHeight":"1.3"}},"fontSize":"big"} -->
                <h3 class="wp-block-heading is-style-modestra-heading-gradient-effect has-big-font-size" style="line-height:1.3"><?php esc_html_e('01.', 'cozy-essential-addons') ?></h3>
                <!-- /wp:heading -->

                <!-- wp:heading {"level":3,"className":"is-style-default","style":{"typography":{"lineHeight":"1.3","textTransform":"uppercase"}},"fontSize":"x-large"} -->
                <h3 class="wp-block-heading is-style-default has-x-large-font-size" style="line-height:1.3;text-transform:uppercase"><?php esc_html_e('Branding', 'cozy-essential-addons') ?></h3>
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <!-- wp:column {"width":"60%"} -->
        <div class="wp-block-column" style="flex-basis:60%"><!-- wp:group {"style":{"spacing":{"margin":{"top":"64px"}}},"layout":{"type":"constrained"}} -->
            <div class="wp-block-group" style="margin-top:64px"><!-- wp:cover {"url":"<?php echo esc_url($ct_patterns_media[0]) ?>","id":4375,"dimRatio":0,"customOverlayColor":"#b4aeae","isUserOverlayColor":true,"isDark":false,"style":{"border":{"radius":"20px"},"color":{"duotone":"var:preset|duotone|primary-black"}},"layout":{"type":"constrained"}} -->
    ...
    <div class="wp-block-columns" style="margin-top:48px"><!-- wp:column {"width":"50%","style":{"spacing":{"blockGap":"var:preset|spacing|30"}}} -->
        <div class="wp-block-column" style="flex-basis:50%"><!-- wp:group {"style":{"position":{"type":"sticky","top":"0px"},"spacing":{"padding":{"top":"40px","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"constrained","contentSize":"100%"}} -->
            <div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:40px;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"level":3,"className":"is-style-modestra-heading-gradient-effect","style":{"typography":{"lineHeight":"1.3"}},"fontSize":"big"} -->
                <h3 class="wp-block-heading is-style-modestra-heading-gradient-effect has-big-font-size" style="line-height:1.3"><?php esc_html_e('02.', 'cozy-essential-addons') ?></h3>
                <!-- /wp:heading -->

                <!-- wp:heading {"level":3,"className":"is-style-default","style":{"typography":{"lineHeight":"1.3","textTransform":"uppercase"}},"fontSize":"x-large"} -->
                <h3 class="wp-block-heading is-style-default has-x-large-font-size" style="line-height:1.3;text-transform:uppercase"><?php esc_html_e('Business Strategy', 'cozy-essential-addons') ?></h3>
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <!-- wp:column {"width":"60%"} -->
        <div class="wp-block-column" style="flex-basis:60%"><!-- wp:group {"style":{"spacing":{"margin":{"top":"64px"}}},"layout":{"type":"constrained"}} -->
            <div class="wp-block-group" style="margin-top:64px"><!-- wp:cover {"url":"<?php echo esc_url($ct_patterns_media[1]) ?>","id":4620,"dimRatio":0,"customOverlayColor":"#908884","isUserOverlayColor":true,"isDark":false,"style":{"border":{"radius":"20px"},"color":{"duotone":"var:preset|duotone|secodnary-white"}},"layout":{"type":"constrained"}} -->
                <div class="wp-block-cover is-light" style="border-radius:20px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#908884"></span><img class="wp-block-cover__image-background wp-image-4620" alt="" src="<?php echo esc_url($ct_patterns_media[1]) ?>" data-object-fit="cover" />
                    <div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
                        <p class="has-text-align-center has-large-font-size"></p>
                        <!-- /wp:paragraph -->
                    </div>
    ...
    <div class="wp-block-columns" style="margin-top:48px"><!-- wp:column {"width":"50%","style":{"spacing":{"blockGap":"var:preset|spacing|30"}}} -->
        <div class="wp-block-column" style="flex-basis:50%"><!-- wp:group {"style":{"position":{"type":"sticky","top":"0px"},"spacing":{"padding":{"top":"40px","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"constrained","contentSize":"100%"}} -->
            <div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:40px;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"level":3,"className":"is-style-modestra-heading-gradient-effect","style":{"typography":{"lineHeight":"1.3"}},"fontSize":"big"} -->
                <h3 class="wp-block-heading is-style-modestra-heading-gradient-effect has-big-font-size" style="line-height:1.3"><?php esc_html_e('03.', 'cozy-essential-addons') ?></h3>
                <!-- /wp:heading -->

                <!-- wp:heading {"level":3,"className":"is-style-default","style":{"typography":{"lineHeight":"1.3","textTransform":"uppercase"}},"fontSize":"x-large"} -->
                <h3 class="wp-block-heading is-style-default has-x-large-font-size" style="line-height:1.3;text-transform:uppercase"><?php esc_html_e('Digital Marketing', 'cozy-essential-addons') ?></h3>
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <!-- wp:column {"width":"60%"} -->
        <div class="wp-block-column" style="flex-basis:60%"><!-- wp:group {"style":{"spacing":{"margin":{"top":"64px"}}},"layout":{"type":"constrained"}} -->
            <div class="wp-block-group" style="margin-top:64px"><!-- wp:cover {"url":"<?php echo esc_url($ct_patterns_media[2]) ?>","id":4619,"dimRatio":0,"customOverlayColor":"#c3c3c6","isUserOverlayColor":true,"isDark":false,"style":{"border":{"radius":"20px"},"color":{"duotone":"var:preset|duotone|white-primary"}},"layout":{"type":"constrained"}} -->
