...
<div class="wp-block-group has-gradient-one-gradient-background has-background" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"className":"saaslauncher-header","style":{"spacing":{"padding":{"top":"22px","right":"var:preset|spacing|40","bottom":"22px","left":"var:preset|spacing|40"},"margin":{"top":"0","bottom":"0"}},"border":{"bottom":{"width":"0px","style":"none"}}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
    ...
    <!-- wp:group {"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"right":"var:preset|spacing|40","left":"var:preset|spacing|40","top":"6rem","bottom":"var:preset|spacing|40"}}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
    <div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:6rem;padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"className":"wp-embed-aspect-4-3 wp-has-aspect-ratio","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
        ...
        <div class="wp-block-group wp-embed-aspect-4-3 wp-has-aspect-ratio" style="margin-top:28px;margin-bottom:0"><!-- wp:buttons {"className":"is-style-button-zoom-on-hover","style":{"spacing":{"margin":{"top":"0px"}}},"layout":{"type":"flex","justifyContent":"center"}} -->
            ...
            <!-- wp:cozy-block/modal {"blockClientId":"53ad5d42-2fbc-4c57-be57-a00f764102a7","boxWidth":780,"modalEvent":"click","backgroundOverlayColor":"#0a0a0ad1","backgroundColor":"#0A0A0A","iconStyles":{"enabled":true,"alignment":"right","horizontalSpacing":20,"verticalSpacing":50,"boxWidth":40,"boxHeight":40,"radius":100,"iconSize":10,"bg":"#AC5BFF","bgHover":"#6967FF","iconColor":"#FFFFFE","iconColorHover":"","border":"1px solid #000","borderRadius":20},"clickButtonStyles":{"padding":{"top":10,"right":10,"bottom":10,"left":10},"content":"image","label":"Open Popup","imgURL":"<?php echo esc_url($ct_patterns_media[0]) ?>","imgWidth":80,"imgHeight":80,"imgRadius":0,"imgHasPulse":true,"fontSize":14,"justify":"center","borderType":"none","borderWidth":{"top":1,"right":1,"bottom":1,"left":1},"borderColor":"#000","borderRadius":60,"color":"#ffffff00","colorHover":"","bgColor":"#ffffff00","bgColorHover":""}} -->
            <a class="cozy-modal-open" data-type="53ad5d42-2fbc-4c57-be57-a00f764102a7">
                <figure class="cozy-modal-open__img has-pulse-animation"><img src="<?php echo esc_url($ct_patterns_media[0]) ?>" /></figure>
            </a>
            <div class="cozy-block-modal  type-default event-click display-none icon-align-right" id="cozyBlock_53ad5d42_2fbc_4c57_be57_a00f764102a7">
        ...
        <!-- wp:group {"className":"wp-embed-aspect-4-3 wp-has-aspect-ratio","style":{"spacing":{"margin":{"top":"64px"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
        <div class="wp-block-group wp-embed-aspect-4-3 wp-has-aspect-ratio" style="margin-top:64px"><!-- wp:group {"className":"is-style-saaslauncher-gradient-border","style":{"border":{"radius":"30px","top":{"radius":"30px","width":"1px"},"right":{"radius":"30px","width":"1px"},"bottom":{"radius":"30px","width":"0px","style":"none"},"left":{"radius":"30px","width":"1px"}}},"backgroundColor":"dark-shade","layout":{"type":"constrained"}} -->
            <div class="wp-block-group is-style-saaslauncher-gradient-border has-dark-shade-background-color has-background" style="border-radius:30px;border-top-width:1px;border-right-width:1px;border-bottom-style:none;border-bottom-width:0px;border-left-width:1px"><!-- wp:image {"id":8635,"sizeSlug":"large","linkDestination":"none","align":"center","className":"is-style-saaslauncher-image-hover-zoom"} -->
                <figure class="wp-block-image aligncenter size-large is-style-saaslauncher-image-hover-zoom"><img src="<?php echo esc_url($ct_patterns_media[1]) ?>" alt="" class="wp-image-8635" /></figure>
                <!-- /wp:image -->
            </div>
            <!-- /wp:group -->
        </div>
