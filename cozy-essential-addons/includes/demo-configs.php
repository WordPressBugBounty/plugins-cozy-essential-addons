	...
	switch ( $theme_slug ) :
		case 'fotawp':
			$demo_templates_lists = array(
				'fotawp'        => array(
					'title'          => esc_html__( 'FotaWP', 'cozy-essential-addons' ), /*Title*/
				...
				'fotawp-free-2' => array(
					'title'          => esc_html__( 'Grid News', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => false,  /*Premium*/
					'type'           => 'free',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-free-3' => array(
					'title'          => esc_html__( 'Fota Store', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => false,  /*Premium*/
					'type'           => 'free',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-free-4' => array(
					'title'          => esc_html__( 'Minimal Agency', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => false,  /*Premium*/
					'type'           => 'free',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-free-5' => array(
					'title'          => esc_html__( 'Travel Agency', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => false,  /*Premium*/
					'type'           => 'free',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-1'  => array(
					'title'          => esc_html__( 'FotaWP Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-2'  => array(
					'title'          => esc_html__( 'StartUp Agency', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'fotawp-pro-3'  => array(
					'title'          => esc_html__( 'Tech/Gadget Blog', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-4'  => array(
					'title'          => esc_html__( 'Lawyer/Law Firm', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-5'  => array(
					'title'          => esc_html__( 'GYM/Fitness Club', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-7'  => array(
					'title'          => esc_html__( 'Fashion Store', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-8'  => array(
					'title'          => esc_html__( 'Photographer/Freelancer', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-9'  => array(
					'title'          => esc_html__( 'Furniture/Decor Store', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-10' => array(
					'title'          => esc_html__( 'App Landing Page', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-11' => array(
					'title'          => esc_html__( 'Corporate Business', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-12' => array(
					'title'          => esc_html__( 'Portfolio/Freelancer', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-13' => array(
					'title'          => esc_html__( 'News/Magazine 2', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-14' => array(
					'title'          => esc_html__( 'Gym Club/Fitness Store', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-15' => array(
					'title'          => esc_html__( 'Electronics Store/Shop', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-16' => array(
					'title'          => esc_html__( 'Kids Care/Pre-School', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-17' => array(
					'title'          => esc_html__( 'Construction Company', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-18' => array(
					'title'          => esc_html__( 'Insurance Agency', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-19' => array(
					'title'          => esc_html__( 'Hospital/Medical/Health', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-20' => array(
					'title'          => esc_html__( 'News/Magazine 3', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-21' => array(
					'title'          => esc_html__( 'HVAC Services', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-22' => array(
					'title'          => esc_html__( 'Multipurpose Agency', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'fotawp', 'multipurpose' ),  /*Search keyword*/
				...
				'fotawp-pro-23' => array(
					'title'          => esc_html__( 'Yatrilife Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'fotawp-pro-24' => array(
					'title'          => esc_html__( 'Eduversity Block Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'fotawp-pro-25' => array(
					'title'          => esc_html__( 'Circle Photography Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'fotawp-pro-26' => array(
					'title'          => esc_html__( 'Showfolio Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'fota-home-solutions':
			$demo_templates_lists = array(
				...
				'home-solutions-pro'  => array(
					'title'          => esc_html__( 'Home Solution Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'fota-speakers':
			$demo_templates_lists = array(
				...
				'fota-speakers-pro' => array(
					'title'          => esc_html__( 'Speakers Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'atozshop':
			$demo_templates_lists = array(
				...
				'atozshop-pro' => array(
					'title'          => esc_html__( 'AtozShop Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'reshape-block':
			$demo_templates_lists = array(
				...
				'reshape-pro'   => array(
					'title'          => esc_html__( 'Reshape Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'fota-magazine':
			$demo_templates_lists = array(
				...
				'fota-magazine-pro' => array(
					'title'          => esc_html__( 'Fota Magazine Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'targetify':
			$demo_templates_lists = array(
				...
				'targetify-pro' => array(
					'title'          => esc_html__( 'Targetify Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'musicmantra':
			$demo_templates_lists = array(
				...
				'musicmantra-pro' => array(
					'title'          => esc_html__( 'MusicMantra Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'hello-agency':
			$demo_templates_lists = array(
				...
				'hello-agency-pro'   => array(
					'title'          => esc_html__( 'Agency Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'hello-agency-pro-2' => array(
					'title'          => esc_html__( 'Light Agency Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'smartversity':
			$demo_templates_lists = array(
				...
				'smartversity-pro' => array(
					'title'          => esc_html__( 'Smartversity Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'revivenews':
			$demo_templates_lists = array(
				...
				'revivenews-pro'   => array(
					'title'          => esc_html__( 'Revivenews Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'revivenews-pro-2' => array(
					'title'          => esc_html__( 'Revivenews Pro 2', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'revivenews pro', 'multipurpose' ),  /*Search keyword*/
				...
				'revivenews-pro-3' => array(
					'title'          => esc_html__( 'Revivenews Pro 3', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'revivenews pro', 'multipurpose' ),  /*Search keyword*/
		...
		case 'storemate':
			$demo_templates_lists = array(
				...
				'storemate-pro'         => array(
					'title'          => esc_html__( 'Storemate Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'storemate-decor'       => array(
					'title'          => esc_html__( 'Arts & Decor PRO', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'storemate-electronics' => array(
					'title'          => esc_html__( 'Electronics & Gadgets PRO', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'storemate-beauty'      => array(
					'title'          => esc_html__( 'Cosmetics and Beauty PRO', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'blockbooster':
			$demo_templates_lists = array(
				...
				'blockbooster-pro' => array(
					'title'          => esc_html__( 'Blockbooster Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'homedroid':
			$demo_templates_lists = array(
				...
				'homedroid-pro' => array(
					'title'          => esc_html__( 'Homedroid Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'publishtify':
			$demo_templates_lists = array(
				...
				'publishtify-pro' => array(
					'title'          => esc_html__( 'Publishtify Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'mighty-builders':
			$demo_templates_lists = array(
				...
				'mighty-builders-pro' => array(
					'title'          => esc_html__( 'Mighty Builders Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'mighty-plumbers':
			$demo_templates_lists = array(
				...
				'mighty-plumbers-pro'  => array(
					'title'          => esc_html__( 'Mighty Plumbers Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'mighty-plumbers-pro2' => array(
					'title'          => esc_html__( 'Mighty Plumbers Pro 2', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'mighty-plumbers pro', 'multipurpose' ),  /*Search keyword*/
		...
		case 'magnewspress':
			$demo_templates_lists = array(
				...
				'magnewspress-pro' => array(
					'title'          => esc_html__( 'MagnewsPress Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'lavisto':
			$demo_templates_lists = array(
				...
				'lavisto-pro'   => array(
					'title'          => esc_html__( 'Lavisto Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'lavisto-pro-2' => array(
					'title'          => esc_html__( 'Lavisto Pro 2', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'lavisto pro', 'multipurpose' ),  /*Search keyword*/
				...
				'lavisto-pro-3' => array(
					'title'          => esc_html__( 'Lavisto Pro 3', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'lavisto pro', 'multipurpose' ),  /*Search keyword*/
		...
		case 'handyman-blocks':
			$demo_templates_lists = array(
				...
				'handyman-blocks-pro'   => array(
					'title'          => esc_html__( 'Handyman Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'handyman-blocks-pro-2' => array(
					'title'          => esc_html__( 'Handyman Pro 2', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'handyman blocks pro', 'multipurpose' ),  /*Search keyword*/
				...
				'handyman-blocks-pro-3' => array(
					'title'          => esc_html__( 'Handyman Pro 3', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'handyman blocks pro', 'multipurpose' ),  /*Search keyword*/
		...
		case 'photolancer':
			$demo_templates_lists = array(
				...
				'photolancer-pro' => array(
					'title'          => esc_html__( 'Photolancer Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'saaslauncher':
			$demo_templates_lists = array(
				...
				'saaslauncher-pro'    => array(
					'title'          => esc_html__( 'SaasLauncher Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'saaslauncher-pro-2'  => array(
					'title'          => esc_html__( 'SaasLauncher Pro 2', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-3'  => array(
					'title'          => esc_html__( 'SaasLauncher Pro 3', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-4'  => array(
					'title'          => esc_html__( 'AI', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-5'  => array(
					'title'          => esc_html__( 'Cyber Security', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-6'  => array(
					'title'          => esc_html__( 'Newsbase', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-7'  => array(
					'title'          => esc_html__( 'Storebase', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-8'  => array(
					'title'          => esc_html__( 'Entrepreneur/Influencer', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-11' => array(
					'title'          => esc_html__( 'Consulting/Business', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-13' => array(
					'title'          => esc_html__( 'Photo Studio', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-14' => array(
					'title'          => esc_html__( 'Digital Marketing Agency', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-15' => array(
					'title'          => esc_html__( 'Chatbot', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-16' => array(
					'title'          => esc_html__( 'Resume/Portfolio', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-17' => array(
					'title'          => esc_html__( 'Medical/Healthcare', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-18' => array(
					'title'          => esc_html__( 'Finance Service/Agency', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-19' => array(
					'title'          => esc_html__( 'Charity/NON Profit', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-20' => array(
					'title'          => esc_html__( 'Hotels/Resort', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-21' => array(
					'title'          => esc_html__( 'Real Estate Agency', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-22' => array(
					'title'          => esc_html__( 'Construction Agency', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-24' => array(
					'title'          => esc_html__( 'Education Consultancy', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-25' => array(
					'title'          => esc_html__( 'Cafe & Restaurant', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-27' => array(
					'title'          => esc_html__( 'Handyman', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-28' => array(
					'title'          => esc_html__( 'Digital Creative Agency', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-29' => array(
					'title'          => esc_html__( 'Cleaning Services', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-30' => array(
					'title'          => esc_html__( 'Home Decor', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-31' => array(
					'title'          => esc_html__( 'Software Company', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-34' => array(
					'title'          => esc_html__( 'SaaS Startup Agency', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-35' => array(
					'title'          => esc_html__( 'Marketing Agency', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-36' => array(
					'title'          => esc_html__( 'SaaS App/Products', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-37' => array(
					'title'          => esc_html__( 'Decor & Furniture Store', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-39' => array(
					'title'          => esc_html__( 'Jewellery Store', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-40' => array(
					'title'          => esc_html__( 'Cosmetics & Skin Care', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-41' => array(
					'title'          => esc_html__( 'Grocery Store', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
				...
				'saaslauncher-pro-42' => array(
					'title'          => esc_html__( 'Electronics & Gadget Store', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'saaslauncher pro' ),  /*Search keyword*/
		...
		case 'modestra':
			$demo_templates_lists = array(
				...
				'modestra-pro'   => array(
					'title'          => esc_html__( 'DEMO PRO 01', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'modestra-pro-2' => array(
					'title'          => esc_html__( 'DEMO PRO 02', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'modestra pro' ),  /*Search keyword*/
				...
				'modestra-pro-3' => array(
					'title'          => esc_html__( 'DEMO PRO 03', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'modestra pro' ),  /*Search keyword*/
		...
		case 'jetnews-magazine':
			$demo_templates_lists = array(
				...
				'jetnews-magazine-pro'    => array(
					'title'          => esc_html__( 'Default Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'jetnews-magazine-pro-2'  => array(
					'title'          => esc_html__( 'Global News', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-3'  => array(
					'title'          => esc_html__( 'Global Mag', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-4'  => array(
					'title'          => esc_html__( 'Tech News', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-5'  => array(
					'title'          => esc_html__( 'NewsMagzin', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-6'  => array(
					'title'          => esc_html__( 'RightNews', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-7'  => array(
					'title'          => esc_html__( 'Classic News', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-8'  => array(
					'title'          => esc_html__( 'Classic Magazine', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-9'  => array(
					'title'          => esc_html__( 'MagazineVX', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-10' => array(
					'title'          => esc_html__( 'MagazineVZ', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-11' => array(
					'title'          => esc_html__( 'History News', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-12' => array(
					'title'          => esc_html__( 'Gadget Blog', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-13' => array(
					'title'          => esc_html__( 'Sport News', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-14' => array(
					'title'          => esc_html__( 'Automotive', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-15' => array(
					'title'          => esc_html__( 'Quick News', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-16' => array(
					'title'          => esc_html__( 'Aqua News', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
				...
				'jetnews-magazine-pro-17' => array(
					'title'          => esc_html__( 'World News', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'jetnews-magazine pro', 'photography' ),  /*Search keyword*/
		...
		case 'shopmighty':
			$demo_templates_lists = array(
				...
				'shopmighty-pro' => array(
					'title'          => esc_html__( 'Shopmighty Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'woxstore':
			$demo_templates_lists = array(
				...
				'woxstore-pro'    => array(
					'title'          => esc_html__( 'WoxStore Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'woxstore-pro-2'  => array(
					'title'          => esc_html__( 'Fashion & Clothing V2', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'woxstore-pro-3'  => array(
					'title'          => esc_html__( 'Cosmetic and Makeup Store', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'woxstore-pro-4'  => array(
					'title'          => esc_html__( 'Footwear & Shoes Store', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'woxstore-pro-5'  => array(
					'title'          => esc_html__( 'Fashion & Accessories', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'woxstore-pro-6'  => array(
					'title'          => esc_html__( 'Watch Store / Watches', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'woxstore-pro-7'  => array(
					'title'          => esc_html__( 'Glasses / Eye Wear', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'woxstore-pro-8'  => array(
					'title'          => esc_html__( 'Riding Gears', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'woxstore-pro-9'  => array(
					'title'          => esc_html__( 'Fitwox', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'woxstore-pro-10' => array(
					'title'          => esc_html__( 'BagStore', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'grocefycart':
			$demo_templates_lists = array(
				...
				'grocefycart-pro' => array(
					'title'          => esc_html__( 'GrocefyCart Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
		...
		case 'orakus':
			$demo_templates_lists = array(
				...
				'orakus-pro'   => array(
					'title'          => esc_html__( 'Orakus Pro', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
				...
				'orakus-pro-2' => array(
					'title'          => esc_html__( 'Orakus Interiors', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'orakus pro', 'multipurpose' ),  /*Search keyword*/
				...
				'orakus-pro-3' => array(
					'title'          => esc_html__( 'Orakus Store', 'cozy-essential-addons' ), /*Title*/
					'is_pro'         => true,  /*Premium*/
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'orakus pro', 'multipurpose' ),  /*Search keyword*/
			...
			$demo_templates_lists = array(
				'homelancer'     => array(
					...
					'template_url'   => array(
						...
						'widgets' => COZYTHEMES_DEMO_IMPORTER_SETUP_TEMPLATE_URL . '/homelancer/free/1/widgets.json',
					),
					'screenshot_url' => COZYTHEMES_DEMO_IMPORTER_SETUP_TEMPLATE_URL . '/homelancer/free/1/screenshot.png',
				...
				'homelancer-pro' => array(
					...
					'type'           => 'premium',
					'author'         => esc_html__( 'CozyThemes', 'cozy-essential-addons' ),    /*Author Name*/
					'keywords'       => array( 'homelancer pro', 'multipurpose' ),  /*Search keyword*/
					'template_url'   => array(
						'content' => COZYTHEMES_DEMO_IMPORTER_SETUP_TEMPLATE_URL . '/homelancer/pro/1/content.json',
